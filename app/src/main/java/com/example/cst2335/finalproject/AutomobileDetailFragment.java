...
public class AutomobileDetailFragment extends Fragment {
    ...
    public static AutomobileDetailFragment newInstance(int index) {
        AutomobileDetailFragment f = new AutomobileDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        text.setText(AutomobileListData.HISTORY[getShownIndex()]);
        return scroller;
    }
}