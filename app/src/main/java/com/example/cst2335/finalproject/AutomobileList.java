...
public class AutomobileList extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> connectArrayToListView = new ArrayAdapter<String>(
                ...
                AutomobileListData.NAMES);

        // Connect the ListView to our data
        setListAdapter(connectArrayToListView);

        // Check if the FrameLayout with the id details exists
        View detailsFrame = getActivity().findViewById(R.id.automobile_details);
    ...
    void showDetails(int index) {
        ...
        if (mDuelPane) {
            ...
            AutomobileDetailFragment details = (AutomobileDetailFragment)
                    getFragmentManager().findFragmentById(R.id.automobile_details);
            ...
            if (mCurCheckPosition == 0) { // Temperature Setting
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileTemp.class);
                startActivity(intent);

            } else if (mCurCheckPosition == 1){ // Fuel level
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileFuel.class);
                startActivity(intent);

            } else if (mCurCheckPosition == 2){ // Radio control
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileRadio.class);
                startActivity(intent);

            } else if (mCurCheckPosition == 3){ // GPS directions
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=45.3483962,-75.7577422&daddr=45.4110075,-75.7097055"));
                startActivity(intent);

            } else if (mCurCheckPosition == 4){ // Lights
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileLight.class);
                startActivity(intent);

            } else if (mCurCheckPosition == 5){ // Odometer
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileOdometer.class);
                startActivity(intent);

            } else if (mCurCheckPosition == 6){ // Drive
                Intent intent = new Intent();
                intent.setClass(getActivity(), AutomobileDrive.class);
                startActivity(intent);
                ...
                intent.setClass(getActivity(), AutomobileDetailActivity.class);
